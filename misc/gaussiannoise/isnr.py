...
original = Image.open('cameraman.png').convert('L')  
noised = Image.open("gaussian_noise.png").convert('L')  
restored_bl = Image.open("gaussian_noise_bilateral_filtering_cam_new2.png").convert('L')  
restored_lpf=Image.open("gaussian_noise_filtered_cam_lpf.png").convert('L')  
